...
function _G.set_terminal_keymaps()
  map('t', '<localleader><esc>', '<C-\\><C-n>')
  map('t', '<localleader>h', '<C-\\><C-n>:wincmd h<CR>')
  map('t', '<localleader>j', '<C-\\><C-n>:wincmd j<CR>')
  map('t', '<localleader>k', '<C-\\><C-n>:wincmd k<CR>')
  map('t', '<localleader>l', '<C-\\><C-n>:wincmd l<CR>')
